...
from nsa.common_utils import prepare_chunk_indices, prepare_chunk_offsets, prepare_lens, prepare_token_indices
from nsa.pooling import mean_pooling
from nsa.utils import autocast_custom_bwd, autocast_custom_fwd, contiguous
...
try:
    ...
    print("Flash Attention is not installed. Please install it for hopper")
